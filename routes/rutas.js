...
router.get("/info", function (req, res){
    // Podrías pasar un valor por defecto o simplemente renderizar
    res.render("info", {c: "Información General"}) 
    // Asegúrate de que info.ejs maneje el caso en que 'c' sea null/undefined si no lo pasas.
})
